  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        animate="visible"
      >
        {/* Threat Status — spans 2 on desktop */}
        <motion.div variants={fadeUp} className="lg:col-span-2">
          <WidgetCard
            ...
            status="success"
          >
            <ThreatStatusWidget data={mockThreatStatus} />
          </WidgetCard>
        </motion.div>
        ...
        <motion.div variants={fadeUp}>
          <WidgetCard title="Recent Reports" icon={<FileIcon />}>
            <WidgetEmpty message="No recent reports." />
          </WidgetCard>
        </motion.div>
        ...
        <motion.div variants={fadeUp}>
          <WidgetCard title="Recent Analysis" icon={<AnalysisIcon />}>
            <WidgetEmpty message="No analysis history." />
          </WidgetCard>
        </motion.div>
        ...
        <motion.div variants={fadeUp} className="lg:col-span-2">
          <WidgetCard title="Threat Timeline" span={2} icon={<TimelineIcon />}>
            <WidgetEmpty message="No threat data yet. Start scanning to build your timeline." />
          </WidgetCard>
        </motion.div>
        ...
        <motion.div variants={fadeUp}>
          <WidgetCard title="Security Tips" icon={<LightbulbIcon />}>
            <WidgetEmpty message="Tips loading..." />
          </WidgetCard>
        </motion.div>
        ...
        <motion.div variants={fadeUp}>
          <WidgetCard title="AEGIS Assistant" icon={<BotIcon />}>
            <WidgetEmpty
              message="AEGIS is ready to help. Ask a question."
              icon={<BotLargeIcon />}
            />
          </WidgetCard>
        </motion.div>
