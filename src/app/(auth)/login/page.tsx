      ...
      >
        <AuthCard>
          <div className="mb-6">
            ...
            <h2 className="text-xl font-bold text-[#F8F8FA]">{config.heading}</h2>
            <p className="mt-1 text-sm text-[#B6B8C4]">{config.subtitle}</p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-3.5 h-3.5 rounded border-[rgba(236,154,163,0.2)] bg-[#0D0D12] text-[#EC9AA3] focus:ring-[#EC9AA3] focus:ring-offset-0"
                />
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[rgba(236,154,163,0.08)]" />
            </div>
            <div className="relative flex justify-center">
              <span className="px-3 text-[10px] text-[#B6B8C4]/60 bg-[#0D0D12]">or continue with</span>
            </div>
          </div>

          <button
            type="button"
            className="w-full py-3 rounded-xl text-sm font-medium text-[#F8F8FA] border border-[rgba(236,154,163,0.12)] bg-[#12121A]/50 hover:border-[rgba(236,154,163,0.25)] hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2"
          >
          ...
          <p className="mt-6 text-center text-xs text-[#B6B8C4]">
            ...
            <Link href={`/register?role=${role}`} className="text-[#EC9AA3] hover:text-[#F3B3BA] font-medium transition-colors">
              Create account
            </Link>
          </p>
        </AuthCard>
