...
export function PipelineSection() {
  ...
  return (
    ...
    >
      {/* Background: subtle grid and glow */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        />
        <div
          className="absolute top-1/2 left-[25%] -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-[0.035]"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2 max-w-lg">
            ...
            <p
              ref={subtitleRef}
              className={`mt-6 text-lg text-slate-600 leading-relaxed ${reducedMotion ? "" : "opacity-0"}`}
            >
              CyberShield doesn&apos;t simply classify messages as safe or unsafe. It
              analyzes relationships, detects hidden patterns, calculates risk,
              and continuously builds fraud intelligence.
            </p>
