...
const cards = [
  {
    ...
    description: "NLP scans text for fraud patterns, urgency markers, and impersonation signals.",
    stageIndex: 1,
  },
  {
    title: "Website Intelligence",
    description: "Analyzes domain age, SSL validity, and phishing pattern matches.",
    stageIndex: 2,
  },
  {
    title: "UPI Detection",
    description: "Traces UPI IDs across reported fraud networks and transaction chains.",
    stageIndex: 3,
  },
  {
    title: "Voice Analysis",
    description: "Detects deepfake audio and social engineering speech patterns.",
    stageIndex: 1,
  },
  {
    title: "Fraud Graph",
    description: "Maps relationships between entities to uncover organized networks.",
    stageIndex: 3,
  },
  {
    title: "Recommendation Engine",
    description: "Generates personalized safety actions based on threat context.",
    stageIndex: 5,
  },
];
