...
const features = [
  {
    ...
    description: "Continuously monitors cyber threats around the clock.",
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Connects millions of digital signals into meaningful intelligence.",
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Citizen First",
    description: "Protects people before attacks become successful.",
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Mission Ready",
    description: "Built for citizens, organizations and cybercrime investigators.",
  },
];
